...
export const Items = [
  //to use this, you must import Items in every screen you want to use it
  {
    id: 1,
    category: "product",
  ...
  },
  {
    ...
    description:
      "One Touch Control & Voice Assistant: With one multifunction button, you can play/pause, previous/next track and answer/hang-up calls.Voice assistant function lets you access siri/Google Assistant",
    productImage: require("../database/images/books/python.jpg"),
    isAvailable: true,
    productImageList: [
      require("../database/images/books/python.jpg"),
      require("../database/images/books/python.jpg"),
      require("../database/images/books/python.jpg"),
    ],
  },
  {
    ...
    description:
      "One Touch Control & Voice Assistant: With one multifunction button, you can play/pause, previous/next track and answer/hang-up calls.Voice assistant function lets you access siri/Google Assistant",
    productImage: require("../database/images/books/chemistry.png"),
    isAvailable: true,
    productImageList: [
      require("../database/images/books/chemistry.png"),
      require("../database/images/books/chemistry.png"),
      require("../database/images/books/chemistry.png"),
    ],
  },
