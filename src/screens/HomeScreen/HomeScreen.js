...
return (
  ...
  <View style={styles.cardView}>
      ...
      <Image style={styles.image} source={require('../../../assets/images/uj.png')}  />
}

{
        open &&
      <Image style={styles.image} source={require('../../../assets/images/qr.png')}></Image>
      ...
      <TouchableOpacity
          ...
          >
            ...
            {  open &&<Text  onPress={()=> setOpen(false)} style={styles.SignText}>Close</Text>}
          </TouchableOpacity>
      </View>
