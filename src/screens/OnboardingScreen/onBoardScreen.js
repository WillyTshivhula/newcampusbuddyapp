...
// Dont forget use replace so that user wont be able to go back
	...
	function renderDetail(){
	   ...
	   <TouchableOpacity onPress={() => nav("SignUp")} style={{justifyContent:'center',
	   alignItems:'center',marginHorizontal:10,marginVertical:5,height:45,
	   borderWidth:1,borderRadius:50,borderColor:"white"}}>
	   ...
	   <TouchableOpacity onPress={myTouch} style={{justifyContent:'center',
	   alignItems:'center',marginHorizontal:10,marginVertical:5,height:45,borderRadius:50}}>
         <Text style={{
		                         color:'#868686',
		                             fontSize:16,
		                     fontWeight:"bold"}}>
